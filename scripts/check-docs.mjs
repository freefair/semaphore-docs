...
for (const id of pages) {
  // Internal fork specifications retain their established Markdown format.
  // Docusaurus still compiles them and verifies their links.
  if (id.startsWith('developer-guide/')) continue;
...
for (const id of pages) {
  // Internal specifications are reached from developer-guide links, not the operator sidebar.
  if (id.startsWith('developer-guide/')) continue;
...
// --- reviewed fork canonical fallbacks ---
// ADR 0011: reviewed product and security guidance takes precedence until
// these translations receive content review. Missing unrelated translations still fail.
const CANONICAL_FALLBACKS = {
  "README": ["de", "es", "fr", "it", "ja", "ko", "pt", "ru", "sr", "zh"],
  "admin-guide/README": ["de", "es", "fr", "it", "ja", "ko", "pt", "ru", "sr", "zh"],
  "admin-guide/authentication/README": ["de", "es", "fr", "it", "ja", "ko", "pt", "ru", "sr", "zh"],
  "admin-guide/authentication/ldap": ["de", "es", "fr", "it", "ja", "ko", "pt", "ru", "sr", "zh"],
  "admin-guide/authentication/local": ["de", "es", "fr", "it", "ja", "ko", "pt", "ru", "sr", "zh"],
  "admin-guide/authentication/openid": ["de", "es", "fr", "it", "ja", "ko", "pt", "ru", "sr", "zh"],
  "admin-guide/configuration": ["de", "es", "fr", "it", "ja", "ko", "pt", "ru", "sr", "zh"],
  "admin-guide/ha": ["de", "es", "fr", "it", "ja", "ko", "pt", "ru", "sr", "zh"],
  "admin-guide/logs": ["de", "es", "fr", "it", "ja", "ko", "pt", "ru", "sr", "zh"],
  "admin-guide/runners": ["de", "es", "fr", "it", "ja", "ko", "pt", "ru", "sr", "zh"],
  "admin-guide/security": ["de", "es", "fr", "it", "ja", "ko", "pt", "ru"],
  "editions": ["de", "es", "fr", "it", "ja", "ko", "pt", "ru", "sr", "zh"],
  "introduction/README": ["de", "es", "fr", "it", "ja", "ko", "pt", "ru", "sr", "zh"],
  "introduction/architecture": ["de", "es", "fr", "it", "ja", "ko", "pt", "ru", "sr", "zh"],
  "introduction/concepts": ["de", "es", "fr", "it", "ja", "ko", "pt", "ru", "sr", "zh"],
  "introduction/security-model": ["de", "es", "fr", "it", "ja", "ko", "pt", "ru", "sr", "zh"],
  "introduction/what-is-semaphore": ["de", "es", "fr", "it", "ja", "ko", "pt", "ru", "sr", "zh"],
  "reference/cli/migrations": ["de", "es", "fr", "it", "ja", "ko", "pt", "ru", "sr", "zh"],
  "reference/cli/runners": ["de", "es", "fr", "it", "ja", "ko", "pt", "ru", "sr", "zh"],
  "reference/cli/users": ["de", "es", "fr", "it", "ja", "ko", "pt", "ru", "sr", "zh"],
  "user-guide/README": ["de", "es", "fr", "it", "ja", "ko", "pt", "ru", "sr", "zh"],
  "user-guide/account": ["de", "es", "fr", "it", "ja", "ko", "pt", "ru", "sr", "zh"],
  "user-guide/apps/terraform/README": ["de", "es", "fr", "it", "ja", "ko", "pt", "ru", "sr", "zh"],
  "user-guide/apps/terraform/states": ["de", "es", "fr", "it", "ja", "ko", "pt", "ru", "sr", "zh"],
  "user-guide/execution-review": ["de", "es", "fr", "it", "ja", "ko", "pt", "ru", "sr", "zh"],
  "user-guide/key-store": ["de", "es", "fr", "it", "ja", "ko", "pt", "ru", "sr", "zh"],
  "user-guide/key-store/aws-secrets-manager": ["de", "es", "fr", "it", "ja", "ko", "pt", "ru", "sr", "zh"],
  "user-guide/key-store/devolutions-server": ["de", "es", "fr", "it", "ja", "ko", "pt", "ru", "sr", "zh"],
  "user-guide/projects": ["de", "es", "fr", "it", "ja", "ko", "pt", "ru", "sr", "zh"],
  "user-guide/projects/runners": ["de", "es", "fr", "it", "ja", "ko", "pt", "ru", "sr", "zh"],
  "user-guide/schedules": ["de", "es", "fr", "it", "ja", "ko", "pt", "ru", "sr", "zh"],
  "user-guide/task-templates/README": ["de", "es", "fr", "it", "ja", "ko", "pt", "ru", "sr", "zh"],
  "user-guide/tasks": ["de", "es", "fr", "it", "ja", "ko", "pt", "ru", "sr", "zh"],
  "user-guide/team": ["de", "es", "fr", "it", "ja", "ko", "pt", "ru", "sr", "zh"],
  "user-guide/workflows": ["de", "es", "fr", "it", "ja", "ko", "pt", "ru", "sr", "zh"]
};
// --- end reviewed fork canonical fallbacks ---

for (const locale of locales) {
  for (const id of sidebarPages) {
    const target = join(I18N, locale, 'docusaurus-plugin-content-docs', 'current', `${id}.md`);
    if (CANONICAL_FALLBACKS[id]?.includes(locale)) {
      if (existsSync(target)) fail(`${locale}/${id}: reviewed canonical fallback must remain absent`);
      continue;
    }
