...
<div class="warning">
  Veuillez lire la section <a href="../faq/troubleshooting.html#6-unable-to-read-ldap-response-packet-unexpected-eof">Dépannage</a> si vous rencontrez des problèmes avec LDAP.
</div>
