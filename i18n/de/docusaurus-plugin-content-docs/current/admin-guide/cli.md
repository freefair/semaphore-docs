...
| Befehlsgruppe | Zweck |
|---------------|-------|
| [`semaphore users`](/admin-guide/cli/users) | Benutzer hinzufügen, ändern, entfernen und anzeigen; API-Tokens und TOTP (2FA) verwalten. |
| [`semaphore projects`](/admin-guide/cli/projects) | Projekte exportieren und importieren (Backups). |
| [`semaphore vaults`](/admin-guide/cli/vaults) | Gespeicherte Geheimnisse neu verschlüsseln und die Verwendung der Verschlüsselungsschlüssel prüfen. |
| [`semaphore runner`](/admin-guide/cli/runners) | Im Runner-Modus laufen sowie Runner registrieren/abmelden. |
| [`semaphore migrate`](/admin-guide/cli/migrations) | Datenbankmigrationen anwenden oder zurückrollen. |
...
Führt Semaphore als Task-Runner aus. Unter [Runner](/admin-guide/cli/runners) finden
...
[Datenbankmigrationen](/admin-guide/cli/migrations) erfahren Sie, wie Sie Migrationen
