...
<div class="warning">
  Consultare la sezione <a href="../faq/troubleshooting.html#6-unable-to-read-ldap-response-packet-unexpected-eof">Risoluzione dei problemi</a> in caso di problemi con LDAP.
</div>
