...
4. Asigne un nombre al inventario y seleccione la credencial de usuario correcta en el desplegable. Seleccione la credencial sudo correcta, si es necesario
5. Seleccione el tipo de inventario
  * Si selecciona archivo, use la ruta absoluta al archivo. Si este archivo se encuentra en su repositorio git, use la ruta relativa. Ej. `inventory/linux-hosts.yaml`
  * Si selecciona estático, pegue o escriba su inventario en el formulario
