...
La mayoría de las tareas administrativas tienen un grupo de comandos dedicado:

| Grupo de comandos | Propósito |
|---------------|---------|
| [`semaphore users`](/admin-guide/cli/users) | Añadir, modificar, eliminar e inspeccionar usuarios; gestionar tokens de API y TOTP (2FA). |
| [`semaphore projects`](/admin-guide/cli/projects) | Exportar e importar proyectos (copias de seguridad). |
| [`semaphore vaults`](/admin-guide/cli/vaults) | Volver a cifrar los secretos almacenados e inspeccionar el uso de las claves de cifrado. |
| [`semaphore runner`](/admin-guide/cli/runners) | Ejecutar en modo runner y registrar/desregistrar runners. |
| [`semaphore migrate`](/admin-guide/cli/migrations) | Aplicar o revertir migraciones de la base de datos. |
...
Ejecuta Semaphore como runner de tareas. Consulte [Runners](/admin-guide/cli/runners) para ver el
...
[Migraciones de la base de datos](/admin-guide/cli/migrations) para aplicar o revertir
