...
<div class="warning">
  Consulte la sección <a href="../faq/troubleshooting.html#6-unable-to-read-ldap-response-packet-unexpected-eof">Solución de problemas</a> si tiene problemas con LDAP.
</div>
