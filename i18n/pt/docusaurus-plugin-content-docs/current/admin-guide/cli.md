...
A maioria das tarefas administrativas tem um grupo de comandos dedicado:

| Grupo de comandos | Finalidade |
|---------------|---------|
| [`semaphore users`](/admin-guide/cli/users) | Adicionar, alterar, remover e inspecionar usuários; gerenciar tokens de API e TOTP (2FA). |
| [`semaphore projects`](/admin-guide/cli/projects) | Exportar e importar projetos (backups). |
| [`semaphore vaults`](/admin-guide/cli/vaults) | Recriptografar segredos armazenados e inspecionar o uso das chaves de criptografia. |
| [`semaphore runner`](/admin-guide/cli/runners) | Executar em modo runner e registrar/cancelar o registro de runners. |
| [`semaphore migrate`](/admin-guide/cli/migrations) | Aplicar ou reverter migrações do banco de dados. |
...
Executa o Semaphore como um runner de tarefas. Consulte [Runners](/admin-guide/cli/runners) para o
...
[Migrações do banco de dados](/admin-guide/cli/migrations) para aplicar ou reverter
