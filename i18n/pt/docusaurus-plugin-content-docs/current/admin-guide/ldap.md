...
<div class="warning">
  Leia a seção <a href="../faq/troubleshooting.html#6-unable-to-read-ldap-response-packet-unexpected-eof">Solução de problemas</a> se você tiver problemas com o LDAP.
</div>
