  ...
  <div className="col col--6 margin-bottom--lg">
    <div className="card">
      ...
      <div className="card__body">
        ...
        <ul>
          <li><a href="/admin-guide/installation">설치</a></li>
          <li><a href="/admin-guide/configuration">구성</a></li>
          <li><a href="/category/reverse-proxy">리버스 프록시 및 TLS</a></li>
          <li><a href="/admin-guide/ldap">LDAP</a> 및 <a href="/admin-guide/openid">OpenID Connect</a></li>
          <li><a href="/admin-guide/security">보안 강화</a></li>
        </ul>
      </div>
    </div>
  </div>
  <div className="col col--6 margin-bottom--lg">
    <div className="card">
      ...
      <div className="card__body">
        ...
        <ul>
          <li><a href="/getting-started">시작하기: 6단계로 첫 번째 작업 실행</a></li>
          <li><a href="/user-guide/projects">프로젝트</a> 및 <a href="/user-guide/team">팀</a></li>
          <li><a href="/user-guide/task-templates">작업 템플릿</a> 및 <a href="/user-guide/tasks">작업</a></li>
          <li><a href="/user-guide/key-store">키 저장소</a>, <a href="/user-guide/inventory">인벤토리</a>, <a href="/user-guide/environment">변수 그룹</a></li>
          <li><a href="/user-guide/schedules">일정</a> 및 <a href="/user-guide/workflows">워크플로</a> (Pro)</li>
        </ul>
      </div>
    </div>
  </div>
    ...
    <div className="card">
      ...
      <div className="card__body">
        ...
        <ul>
          ...
          <li><a href="/admin-guide/ha">고가용성</a></li>
          <li><a href="/admin-guide/upgrading">업그레이드</a></li>
          <li><a href="/admin-guide/logs">로그</a> 및 <a href="/admin-guide/metrics">메트릭</a></li>
          <li><a href="/category/notifications">알림</a></li>
        </ul>
      </div>
    </div>
  </div>
  <div className="col col--6 margin-bottom--lg">
    <div className="card">
      ...
      <div className="card__body">
        ...
        <ul>
          <li><a href="/admin-guide/configuration/config-file">구성 파일</a> 및 <a href="/admin-guide/configuration/env-vars">환경 변수</a></li>
          <li><a href="/admin-guide/api">REST API</a></li>
          <li><a href="/admin-guide/cli">CLI</a></li>
          <li><a href="/admin-guide/cicd">CI/CD 통합</a></li>
          <li><a href="/faq/troubleshooting">문제 해결 FAQ</a></li>
        </ul>
      </div>
    </div>
  </div>
