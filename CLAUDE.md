...
Semaphore EX ships one full-featured product as defined by ADR 0010.
Upstream MDX edition components are compatibility tags and render no badge.
Describe implemented features through configuration and permissions; identify unimplemented providers explicitly.
Keep the capability table consistent with the selected Enhanced module.
Canonical-English fallbacks protect reviewed product and security content while translations are updated.
