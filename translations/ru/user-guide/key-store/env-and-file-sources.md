...
| **Storage**  | Внешнее хранилище секретов, например [HashiCorp Vault](../../../../docs/user-guide/key-store/hashicorp-vault.md) | Хранилище и путь к секрету |
...
Правила приоритета описаны в разделе [Каталог секретов](../../../../docs/admin-guide/configuration/config-file.md#secrets-directory).
