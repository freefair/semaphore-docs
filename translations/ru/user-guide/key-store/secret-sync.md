...
- **На уровне окружения** — [группа переменных](../../../../docs/user-guide/environment.md) может ссылаться на хранилище и его пути синхронизации, чтобы импортировать секреты как **переменные окружения**, ограниченные этой группой.
