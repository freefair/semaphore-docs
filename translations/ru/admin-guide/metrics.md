...
![Grafana Explore с собранными метриками Semaphore](../../../static/assets/semaphore-grafana-explore.png)
...
![Дашборд Grafana с панелями Semaphore](../../../static/assets/semaphore-grafana-dashboard.png)
