...
[страницу руководства пользователя о JWT для задач](../../../../docs/user-guide/task-templates/jwt.md).
...
> [`access_key_encryption`](../../../../docs/admin-guide/configuration/config-file.md). Убедитесь,
