...
![인벤토리 목록](../../../static/assets/inventory-list.webp)
...
자격 증명에 대한 정보는 이 사이트의 [키 저장소](../../../docs/user-guide/key-store.md) 섹션에서 확인할 수 있습니다.
...
| `static-yaml` | 웹 UI에서 편집하는 YAML 형식의 인벤토리입니다. [NetBox](inventory/netbox-dynamic-inventory.md)나 [Consul](inventory/consul-dynamic-inventory.md)과 같은 플러그인 인벤토리에 사용하십시오. |
...
| `terraform-workspace`, `tofu-workspace`, `terragrunt-workspace` | Ansible 인벤토리가 아니라 [Terraform/OpenTofu](apps/terraform/workspaces.md) 및 [Terragrunt](apps/terragrunt.md) 템플릿을 위한 워크스페이스입니다. |
