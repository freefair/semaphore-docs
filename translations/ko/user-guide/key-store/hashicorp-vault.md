...
HashiCorp Vault는 [변수 그룹](../../../../docs/user-guide/environment.md)의 스토리지로도 사용할 수 있습니다. 변수 그룹을 편집할 때 스토리지 유형으로 **HashiCorp Vault**를 선택하고 시크릿을 저장할 폴더의 경로를 지정합니다.
