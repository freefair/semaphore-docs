...
| **Storage**  | [HashiCorp Vault](../../../../docs/user-guide/key-store/hashicorp-vault.md)와 같은 외부 시크릿 스토리지 | 스토리지와 시크릿 경로 |
...
우선순위 규칙은 [시크릿 디렉터리](../../../../docs/admin-guide/configuration/config-file.md#secrets-directory)를 참조하십시오.
