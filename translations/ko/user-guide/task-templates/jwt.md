...
[서버에서 JWT 발급이 활성화된 경우](../../../../docs/admin-guide/security/jwt.md),
...
[키 저장소](../../../../docs/user-guide/key-store.md)에 저장된 장기 시크릿에 비해 갖는 장점은
...
[JWT 발급을 활성화한](../../../../docs/admin-guide/security/jwt.md) 경우에만 표시됩니다)
**JWT enabled**를 체크합니다.
