...
자세한 내용은 [스케줄](../../../../docs/user-guide/schedules.md) 문서를 참고하십시오.
...
자세한 내용은 [통합](../integrations.md) 문서를 참고하십시오.
...
설문 변수는 [변수 그룹](../environment.md)과 잘 어울립니다:
