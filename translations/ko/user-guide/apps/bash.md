...
![Bash 템플릿의 새 작업 대화 상자](../../../../static/assets/task-new-bash.webp)
...
- 매우 짧은 스크립트가 로그 출력을 생성하지 않는 경우, 문제 해결 가이드의 [Bash 스크립트 출력이 누락되거나 불완전함](../../../../docs/faq/troubleshooting.md#bash-script-output-is-missing-or-incomplete)을 참조하십시오.
- 원격 호스트에서 명령을 실행하려면 대신 [Ansible](ansible.md)을 사용하십시오.
