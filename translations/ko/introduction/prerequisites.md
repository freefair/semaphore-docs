...
실행할 자동화와 그 주변 환경에 속합니다. [설치](../../../docs/admin-guide/installation.md)에 앞서 이
...
[러너](../../../docs/admin-guide/runners.md)로 옮기고 러너 쪽 크기를 정하세요.
...
[고가용성](../../../docs/admin-guide/ha.md)에는 PostgreSQL 또는 MySQL과 Redis가 필요하며 SQLite는 사용할
...
| 사용 중인 ID 공급자 | [LDAP](../../../docs/admin-guide/authentication/ldap.md) 또는 [OpenID Connect](../../../docs/admin-guide/authentication/openid.md) 로그인. |
| 알림 채널 | 이메일, Telegram, Slack 등. |

기본 설정에서 사용자는 `3000` 포트로 웹 인터페이스에 접속합니다. 누군가 로그인하기 전에
그 앞에 [TLS](../../../docs/admin-guide/reverse-proxy/README.md)를 두세요. 세션과 API 토큰이 그 위로 오갑니다.
...
- Docker 이미지에는 Ansible, Terraform, OpenTofu와 일반적인 의존성이 포함되어 있습니다.
  ...
  [추가 Python 의존성 설치](../../../docs/admin-guide/installation/docker.md#installing-additional-python-dependencies)를
  참고하세요.
- 패키지나 바이너리로 설치하면 Semaphore만 설치됩니다. Git, Python, Ansible과 필요한
  컬렉션이나 프로바이더는 직접 설치해야 합니다.
  [수동 설치](../../../docs/admin-guide/installation_manually.md)를 참고하세요.
...
이 모든 것은 저장소가 아니라 [키 저장소](../../../docs/user-guide/key-store.md)에 두어야 합니다.
...
- [설치](../../../docs/admin-guide/installation.md) — 방법을 선택하고 설치하기.
- [구성](../../../docs/admin-guide/configuration.md) — 옵션을 지정하는 방법과 각 옵션의 의미.
- [시작하기](../../../docs/getting-started/README.md) — 설치된 서버에서 첫 태스크까지.
