...
Semaphore에는 [내장 TLS](../../../../docs/admin-guide/security/network.md#tls) 기능도 있으므로 프록시가 반드시
...
- **공개 URL로 설정된 `web_host`.** Semaphore는 이 값을 사용해 리디렉션 URL을 만들고, 쿠키의
  ...
  일치하지 않으면 로그인이 실패합니다.
  [설정](../../../../docs/admin-guide/configuration.md)을 참조하십시오.
...
| 페이지 | 내용 |
|---|---|
| [nginx](../../../../docs/admin-guide/reverse-proxy/nginx.md) | TLS, WebSocket 업그레이드 및 전달 헤더를 포함한 server 블록입니다. |
| [Apache](../../../../docs/admin-guide/reverse-proxy/apache.md) | `mod_proxy`와 `mod_proxy_wstunnel`을 사용하는 가상 호스트입니다. |
| [Caddy](../../../../docs/admin-guide/reverse-proxy/caddy.md) | 인증서를 자동으로 발급받는 최소한의 Caddyfile입니다. |
...
[Caddy](../../../../docs/admin-guide/reverse-proxy/caddy.md)가 가장 빠른 길입니다. 인증서를 스스로 발급하고
갱신하기 때문입니다.

TLS를 넘어선 강화 방법은 [네트워크 보안](../../../../docs/admin-guide/security/network.md)을 참조하십시오.
