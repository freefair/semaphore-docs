...
> **Tip**
>
> Python/Ansible/Systemd 환경을 설정하는 방법은 [수동 설치](../installation_manually.md)를 참조하십시오!
...
더 자세한 내용은 [확장 Systemd 서비스 문서](../installation_manually.md#extended-systemd-service)를 참조하십시오.
