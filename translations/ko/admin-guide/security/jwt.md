...
구성과 작업 내부에서의 사용 방법은
[작업 JWT에 관한 사용자 가이드 페이지](../../../../docs/user-guide/task-templates/jwt.md)를 참조하십시오.
...
>
> 서명 키는
> [`access_key_encryption`](../../../../docs/admin-guide/configuration/config-file.md) 키로 저장 시 암호화됩니다. JWT를
