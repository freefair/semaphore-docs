...
[명령 레퍼런스](../../../../docs/reference/cli/commands.md)를 참고하세요. 대부분의 관리 작업에는 전용 명령 그룹이 있습니다.

| 명령 그룹 | 용도 |
|---------------|---------|
| [`semaphore users`](../../../../docs/reference/cli/users.md) | 사용자 추가, 변경, 삭제, 조회 및 API token과 TOTP(2FA) 관리. |
| [`semaphore projects`](../../../../docs/reference/cli/projects.md) | 프로젝트 내보내기 및 가져오기(백업). |
| [`semaphore vaults`](../../../../docs/reference/cli/vaults.md) | 저장된 비밀 정보 재암호화 및 암호화 키 사용 현황 확인. |
| [`semaphore runner`](../../../../docs/reference/cli/runners.md) | runner 모드로 실행하고 runner를 등록/등록 해제. |
| [`semaphore migrate`](../../../../docs/reference/cli/migrations.md) | 데이터베이스 마이그레이션 적용 또는 롤백. |
...
[구성](../../../../docs/admin-guide/configuration.md)을 참고하십시오.
...
`start`, `unregister`)은 [Runner](../../../../docs/reference/cli/runners.md)를 참고하십시오.
...
롤백하는 방법은 [데이터베이스 마이그레이션](../../../../docs/reference/cli/migrations.md)을
참고하십시오.
