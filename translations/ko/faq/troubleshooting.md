...
## localhost에 대한 Gathering Facts 문제
...
`git_client` 및 `git_attempts`에 대한 자세한 내용은 [Git 작업](../../../docs/admin-guide/configuration/config-file.md#git-operations)을 참조하십시오.

---

<a id="bash-script-output-is-missing-or-incomplete"></a>

## Bash 스크립트 출력이 누락되거나 불완전함
...
각 옵션의 의미는 [LDAP 및 AD](../../../docs/admin-guide/authentication/ldap.md)를 참조하십시오.
