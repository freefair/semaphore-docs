...
[Verschlüsselungsschlüssel](../../../../docs/admin-guide/security/encryption.md).

<a id="re-encrypting-secrets-vault-rekey"></a>

## Geheimnisse neu verschlüsseln (`vault rekey`)
...
### Legacy-Migration von einem einzelnen Schlüssel
...
## Schlüsselverwendung prüfen (`vault check`)
