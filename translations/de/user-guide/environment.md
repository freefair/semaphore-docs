...
![Liste der Variablengruppen](../../../static/assets/variable-groups-list.webp)
...
## Eine Variablengruppe erstellen
...
## Eine Variablengruppe aktualisieren
...
## Verwendung von Variablengruppen - Terraform/OpenTofu
