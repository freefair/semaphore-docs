...
![](../../../../static/assets/bitbucket_access_token_1.webp)
...
![](../../../../static/assets/bitbucket_access_token_2.webp)
...
3. Geben Sie `x-token-auth` als **Login** ein und fügen Sie den zuvor kopierten Schlüssel in das Feld **Passwort** ein. Speichern Sie den Schlüssel.<br/><br/>![](../../../../static/assets/bitbucket_access_token_3.png)
4. Gehen Sie zum Bereich **Repositories** und klicken Sie auf die Schaltfläche **Neues Repository**.
5. Geben Sie die HTTPS-URL des Repositories ein (`https://bitbucket.org/path/to/repo`), geben Sie den richtigen Branch ein und wählen Sie den zuvor erstellten **Zugangsschlüssel** aus.<br/><br/>![](../../../../static/assets/bitbucket_access_token_4.webp)
