...
Semaphore unterstützt Artefakte nicht von Haus aus, es stellt lediglich eine Task-Versionierung bereit. Die Erstellung der Artefakte müssen Sie selbst implementieren. Lesen Sie den Artikel [CI/CD](../../admin-guide/cicd.md), um zu erfahren, wie das geht.
