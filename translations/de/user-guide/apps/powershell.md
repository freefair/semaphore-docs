...
## Ein PowerShell-Template erstellen
...
## Ausführung auf Windows-Hosts

PowerShell-Templates erfordern entweder:
- Einen **Windows-Runner** – einen Semaphore-Runner, der auf einem Windows-Host bereitgestellt ist. Siehe [Runner](../../../../docs/admin-guide/runners.md).
