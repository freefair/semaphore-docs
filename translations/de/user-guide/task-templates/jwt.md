...
Wenn die [JWT-Ausstellung auf dem Server aktiviert ist](../../../../docs/admin-guide/security/jwt.md),
...
[Key Store](../../../../docs/user-guide/key-store.md) besteht darin, dass jeder Task ein **frisches Token
...
## JWTs für ein Template aktivieren

Scrollen Sie im Template-Formular zum Abschnitt **JWT** (er erscheint nur, wenn der
Administrator die [JWT-Ausstellung aktiviert](../../../../docs/admin-guide/security/jwt.md) hat) und
...
## Das Token innerhalb eines Tasks verwenden
...
### 1. JWT-Auth-Methode konfigurieren
...
### 3. Eine an ein Template gebundene OpenBao-Rolle definieren
