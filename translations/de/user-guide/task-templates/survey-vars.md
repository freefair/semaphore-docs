...
Weitere Details finden Sie in der Dokumentation zu [Zeitplänen](../../../../docs/user-guide/schedules.md).
...
Weitere Details finden Sie in der Dokumentation zu [Integrationen](../integrations.md).
...
Survey-Variablen lassen sich gut mit [Variablengruppen](../environment.md) kombinieren:
