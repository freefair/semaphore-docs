...
Siehe [Terraform-Workspaces](../../../../docs/user-guide/apps/terraform/workspaces.md) für die detaillierte Einrichtung.
...
## Bash-, PowerShell- und Python-Prompts

Für Bash-, PowerShell- und Python-Templates sind die Prompts minimal, da die meisten Anpassungen über [Survey-Variablen](../../../../docs/user-guide/task-templates/survey-vars.md) erfolgen.
...
Siehe [Integrationen](../integrations.md) für die Webhook-Konfiguration.
...
### Nur notwendige Prompts aktivieren
...
### Mit Survey-Variablen kombinieren
...
### Limit für sicheres Testen verwenden
...
### Schrittweises Rollout mit Limit
...
### Umgebungsverwaltung mit Workspaces
...
### Limit kann nicht angegeben werden
...
### API-Aufrufe mit Prompt-Werten schlagen fehl
...
- [Survey-Variablen](../../../../docs/user-guide/task-templates/survey-vars.md) – Eigene Felder für Templates
- [Ansible-Templates](../../../../docs/user-guide/apps/ansible.md) – Ansible-spezifische Konfiguration
- [Terraform-Templates](../../../../docs/user-guide/apps/terraform/README.md) – Terraform-spezifische Konfiguration
- [Zeitpläne](../../../../docs/user-guide/schedules.md) – Automatisierte Task-Ausführung
- [Integrationen](../integrations.md) – Über Webhooks ausgelöste Tasks
