...
![Projektverlauf](../../../../static/assets/project-dashboard-history.webp)
...
| **Version** | Bei [Build- und Deploy-Task-Templates](../task-templates/build-deploy.md): die gebaute oder bereitgestellte Version. Bei anderen Task Templates nur ein Statussymbol. |
| **Status** | Aktuelles Status-Badge, siehe [Task-Status](../../../../docs/user-guide/tasks.md#task-statuses). |
...
Wenn das Limit erreicht ist, werden die ältesten Tasks dieses Task Template zusammen mit ihren Protokollen gelöscht. Die vollständige Liste der Optionen finden Sie unter [Konfiguration](../../../../docs/admin-guide/configuration.md).

<a id="see-also"></a>

## Siehe auch

- [Stats](stats.md): aggregierte Task-Ergebnisse pro Tag.
- [Activity](activity.md): Audit-Protokoll der Änderungen im Projekt.
