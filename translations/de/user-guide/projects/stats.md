...
![Projektstatistiken](../../../../static/assets/project-stats.webp)
...
Dasselbe Diagramm ist für ein einzelnes Task Template auf dem Tab **Details** der [Task-Template-Seite](../../../../docs/user-guide/task-templates/README.md#template-page) verfügbar.

Um einzelne Ausführungen anstelle aggregierter Zahlen zu sehen, verwenden Sie den Tab [History](history.md).
