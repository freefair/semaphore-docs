...
![Inventory-Liste](../../../static/assets/inventory-list.webp)
...
Informationen zu Zugangsschlüsseln finden Sie im Abschnitt [Key Store](../../../docs/user-guide/key-store.md) dieser Website.
...
| `static-yaml` | Inventory im YAML-Format, das in der Web-Oberfläche bearbeitet wird. Verwenden Sie es für Plugin-Inventories wie [NetBox](inventory/netbox-dynamic-inventory.md) oder [Consul](inventory/consul-dynamic-inventory.md). |
...
| `terraform-workspace`, `tofu-workspace`, `terragrunt-workspace` | Kein Ansible-Inventory: ein Workspace für [Terraform/OpenTofu](apps/terraform/workspaces.md)- und [Terragrunt](apps/terragrunt.md)-Task-Templates. |
