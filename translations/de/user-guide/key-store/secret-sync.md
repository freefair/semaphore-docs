...
## Wie ein Sync-Pfad funktioniert
...
## Was die Synchronisierung mit Ihren Schlüsseln macht
...
## Zwei Geltungsbereiche: gemeinsame Schlüssel und Umgebungsvariablen
...
- **Umgebungsebene** — eine [Variablengruppe](../../../../docs/user-guide/environment.md) kann auf einen Speicher und dessen Sync-Pfade verweisen, um Secrets als **Umgebungsvariablen** zu importieren, die auf diese Gruppe beschränkt sind.
