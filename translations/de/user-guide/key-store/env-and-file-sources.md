...
| **Storage**  | Externer Secret-Speicher wie [HashiCorp Vault](../../../../docs/user-guide/key-store/hashicorp-vault.md) | Speicher und Secret-Pfad |
...
Die Vorrangregeln finden Sie unter [Secrets-Verzeichnis](../../../../docs/admin-guide/configuration/config-file.md#secrets-directory).
