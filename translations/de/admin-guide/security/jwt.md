...
[Seite zu Task-JWTs im Benutzerhandbuch](../../../../docs/user-guide/task-templates/jwt.md).
...
> [`access_key_encryption`](../../../../docs/admin-guide/configuration/config-file.md)-Schlüssel verschlüsselt. Stellen Sie
