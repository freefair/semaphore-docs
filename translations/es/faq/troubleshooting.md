...
## El runner muestra el error 404
...
## El clone o pull de Git falla de forma intermitente
...
Consulte [Operaciones de Git](../../../docs/admin-guide/configuration/config-file.md#git-operations) para más detalles sobre `git_client` y `git_attempts`.

---

<a id="bash-script-output-is-missing-or-incomplete"></a>

## La salida del script Bash falta o está incompleta
...
Consulte [LDAP y AD](../../../docs/admin-guide/authentication/ldap.md) para conocer el significado de cada opción.
