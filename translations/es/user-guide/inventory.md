...
![Lista de inventarios](../../../static/assets/inventory-list.webp)
...
Encontrará información sobre las credenciales en la sección [Almacén de claves](../../../docs/user-guide/key-store.md) de este sitio.
...
| `static-yaml` | Inventario en formato YAML que se edita en la interfaz web. Úselo para inventarios de complementos como [NetBox](inventory/netbox-dynamic-inventory.md) o [Consul](inventory/consul-dynamic-inventory.md). |
...
| `terraform-workspace`, `tofu-workspace`, `terragrunt-workspace` | No es un inventario de Ansible: es un espacio de trabajo para las plantillas de [Terraform/OpenTofu](apps/terraform/workspaces.md) y [Terragrunt](apps/terragrunt.md). |
