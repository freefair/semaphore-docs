...
Una plantilla de compilación produce un artefacto: un tarball, una imagen de contenedor, un paquete. Cada tarea de compilación recibe una versión autoincrementada, a partir de la **Versión inicial** de la plantilla (por ejemplo, `1.0.0`). La versión se muestra en la columna **Versión** de la lista de plantillas y del historial de tareas.
  ...
  ![Cuadro de diálogo Nueva tarea de una plantilla de compilación](../../../../static/assets/task-new-build.webp)
...
![Cuadro de diálogo Nueva tarea de una plantilla de despliegue](../../../../static/assets/task-new-deploy.webp)
...
Para encadenar más de dos pasos, añadir aprobaciones o ramificar en caso de error, use [Flujos de trabajo](../../../../docs/user-guide/workflows.md).
