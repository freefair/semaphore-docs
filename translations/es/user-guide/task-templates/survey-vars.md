...
## Variables de encuesta frente a prompts
...
## Agregar variables de encuesta a una plantilla
...
## Cómo se pasan las variables de encuesta a las tareas
...
### Plantillas de Terraform/OpenTofu
...
## Uso de las variables de encuesta
...
Consulte la documentación de [Programaciones](../../../../docs/user-guide/schedules.md) para más detalles.
...
Consulte la documentación de [Integraciones](../integrations.md) para más detalles.
...
### Utilice enum o select para opciones conocidas
...
### Utilice el destino de variable de entorno de forma deliberada
...
### Marque los campos obligatorios de forma adecuada
...
### Utilice secretos para datos sensibles
...
### Combínelas con grupos de variables

Las variables de encuesta funcionan bien junto con los [grupos de variables](../environment.md):
...
## Diferencias con los grupos de variables
