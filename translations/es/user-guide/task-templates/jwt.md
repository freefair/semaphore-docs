...
Cuando [la emisión de JWT está habilitada en el servidor](../../../../docs/admin-guide/security/jwt.md),
...
[almacén de claves](../../../../docs/user-guide/key-store.md) es que cada tarea obtiene un **token nuevo
...
administrador ha [habilitado la emisión de JWT](../../../../docs/admin-guide/security/jwt.md)) y
