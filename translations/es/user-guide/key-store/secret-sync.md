...
## Cómo funciona una ruta de sincronización
...
## Ejecución de una sincronización
...
## Qué hace la sincronización con sus claves
...
## Dos ámbitos: claves compartidas y variables de entorno
...
- **Nivel de entorno** — un [grupo de variables](../../../../docs/user-guide/environment.md) puede apuntar a un almacenamiento y a sus rutas de sincronización para importar secretos como **variables de entorno** limitadas a ese grupo.
