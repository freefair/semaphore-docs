...
| **Storage**  | Un almacenamiento externo de secretos como [HashiCorp Vault](../../../../docs/user-guide/key-store/hashicorp-vault.md) | El almacenamiento y la ruta del secreto |
...
Consulte [Directorio de secretos](../../../../docs/admin-guide/configuration/config-file.md#secrets-directory) para conocer las reglas de precedencia.
