...
3. Introduzca `x-token-auth` como **Login** y pegue la clave copiada anteriormente en el campo **Contraseña**. Guarde la clave.<br/><br/>![](../../../../static/assets/bitbucket_access_token_3.png)
4. Vaya a la sección **Repositorios** y haga clic en el botón **Nuevo repositorio**.
5. Introduzca la URL HTTPS del repositorio (`https://bitbucket.org/path/to/repo`), introduzca la rama correcta y seleccione la **clave de acceso** creada anteriormente.<br/><br/>![](../../../../static/assets/bitbucket_access_token_4.webp)
