...
## Creación de una plantilla Python
...
- **Docker (paquetes adicionales)**: monte un `requirements.txt` en `/etc/semaphore/requirements.txt` en el contenedor del servidor o del runner. Semaphore lo instala en el entorno virtual de Python incluido en cada arranque del contenedor. Consulte [Instalación de dependencias adicionales de Python](../../../../docs/admin-guide/installation/docker.md#installing-additional-python-dependencies).
