...
Semaphore no admite artefactos de forma nativa, solo proporciona el versionado de las tareas. Debe implementar usted mismo la creación de los artefactos. Lea el artículo [CI/CD](../../admin-guide/cicd.md) para saber cómo hacerlo.
...
#### Ejecutar una tarea cuando se añade un nuevo commit al repositorio
...
#### Argumentos adicionales de Galaxy
