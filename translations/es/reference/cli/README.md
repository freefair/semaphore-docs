...
[referencia de comandos](../../../../docs/reference/cli/commands.md). La mayoría de las tareas
administrativas tienen un grupo de comandos dedicado:

| Grupo de comandos | Propósito |
|---------------|---------|
| [`semaphore users`](../../../../docs/reference/cli/users.md) | Añadir, modificar, eliminar e inspeccionar usuarios; gestionar tokens de API y TOTP (2FA). |
| [`semaphore projects`](../../../../docs/reference/cli/projects.md) | Exportar e importar proyectos (copias de seguridad). |
| [`semaphore vaults`](../../../../docs/reference/cli/vaults.md) | Volver a cifrar los secretos almacenados e inspeccionar el uso de las claves de cifrado. |
| [`semaphore runner`](../../../../docs/reference/cli/runners.md) | Ejecutar en modo runner y registrar/desregistrar runners. |
| [`semaphore migrate`](../../../../docs/reference/cli/migrations.md) | Aplicar o revertir migraciones de la base de datos. |
...
### Cómo se localiza el archivo de configuración
...
[Configuración](../../../../docs/admin-guide/configuration.md) para ver la lista completa de opciones.
...
Ejecuta Semaphore como runner de tareas. Consulte [Runners](../../../../docs/reference/cli/runners.md) para ver el
...
[Migraciones de la base de datos](../../../../docs/reference/cli/migrations.md) para aplicar o revertir
