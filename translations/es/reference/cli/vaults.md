...
[Claves de cifrado](../../../../docs/admin-guide/security/encryption.md).

<a id="re-encrypting-secrets-vault-rekey"></a>

## Volver a cifrar los secretos (`vault rekey`)
...
### Migración heredada de clave única
...
## Comprobar el uso de las claves (`vault check`)
