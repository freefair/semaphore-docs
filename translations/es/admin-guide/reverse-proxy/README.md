...
[TLS integrado](../../../../docs/admin-guide/security/network.md#tls), así que el proxy no es
...
- **`web_host` con la URL pública.** A partir de este valor, Semaphore construye las
  ...
  [Configuración](../../../../docs/admin-guide/configuration.md).
...
| Página | Qué cubre |
|---|---|
| [nginx](../../../../docs/admin-guide/reverse-proxy/nginx.md) | Un bloque server con TLS, la actualización a WebSocket y las cabeceras reenviadas. |
| [Apache](../../../../docs/admin-guide/reverse-proxy/apache.md) | Un host virtual que usa `mod_proxy` y `mod_proxy_wstunnel`. |
| [Caddy](../../../../docs/admin-guide/reverse-proxy/caddy.md) | Un Caddyfile mínimo con certificados automáticos. |
...
existente, [Caddy](../../../../docs/admin-guide/reverse-proxy/caddy.md) es el camino más corto: obtiene
y renueva los certificados por su cuenta.

Para un refuerzo más allá de TLS, consulte [Seguridad de red](../../../../docs/admin-guide/security/network.md).
