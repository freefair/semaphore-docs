...
![Elenco degli Inventory](../../../static/assets/inventory-list.webp)
...
Le informazioni sulle credenziali sono disponibili nella sezione [Key Store](../../../docs/user-guide/key-store.md) di questo sito.
...
| `static-yaml` | Inventory in formato YAML modificato nell'interfaccia web. Da utilizzare per gli Inventory basati su plugin come [NetBox](inventory/netbox-dynamic-inventory.md) o [Consul](inventory/consul-dynamic-inventory.md). |
...
| `terraform-workspace`, `tofu-workspace`, `terragrunt-workspace` | Non è un Inventory di Ansible: è un workspace per i Task Template [Terraform/OpenTofu](apps/terraform/workspaces.md) e [Terragrunt](apps/terragrunt.md). |

<a id="creating-an-inventory"></a>

## Creazione di un Inventory
