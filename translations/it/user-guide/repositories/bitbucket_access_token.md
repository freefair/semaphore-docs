...
3. Inserire `x-token-auth` come **Login** e incollare la chiave copiata in precedenza nel campo **Password**. Salvare la chiave.<br/><br/>![](../../../../static/assets/bitbucket_access_token_3.png)
4. Andare nella sezione **Repository** e fare clic sul pulsante **Nuovo repository**.
5. Inserire l'URL HTTPS del repository (`https://bitbucket.org/path/to/repo`), inserire il branch corretto e selezionare la **Chiave di accesso** creata in precedenza.<br/><br/>![](../../../../static/assets/bitbucket_access_token_4.webp)
