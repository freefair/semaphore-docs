...
<a id="build-templates"></a>

## Task Template di build
...
Un Task Template di build produce un artefatto: un tarball, un'immagine di container, un pacchetto. Ogni Task di build riceve una versione incrementata automaticamente, a partire dalla **Start Version** del Task Template (ad esempio `1.0.0`). La versione è mostrata nella colonna **Version** dell'elenco dei Task Template e nella cronologia dei Task.
  ...
  ![Finestra di dialogo New Task per un Task Template di build](../../../../static/assets/task-new-build.webp)
...
![Finestra di dialogo New Task per un Task Template di deploy](../../../../static/assets/task-new-deploy.webp)
...
<a id="the-semaphore_vars-variable"></a>

## La variabile `semaphore_vars`
...
Per concatenare più di due step, aggiungere approvazioni o diramare in caso di errore, utilizzare i [Workflow](../../../../docs/user-guide/workflows.md).
