...
Quando [l'emissione di JWT è abilitata sul server](../../../../docs/admin-guide/security/jwt.md),
...
[Key Store](../../../../docs/user-guide/key-store.md) è che ogni task riceve un **token nuovo
...
l'amministratore ha [abilitato l'emissione di JWT](../../../../docs/admin-guide/security/jwt.md)) e
