...
## Variabili survey e prompt a confronto
...
## Aggiunta di variabili survey a un template
...
## Passa variabile come (destinazione)
...
## Come le variabili survey vengono passate ai task
...
## Utilizzo delle variabili survey
...
Consultare la documentazione sulle [Pianificazioni](../../../../docs/user-guide/schedules.md) per maggiori dettagli.
...
Consultare la documentazione sulle [Integrazioni](../integrations.md) per maggiori dettagli.
...
### Utilizzare enum o select per le opzioni note
...
### Utilizzare la destinazione variabile d'ambiente con criterio
...
### Contrassegnare i campi obbligatori in modo appropriato
...
### Utilizzare i secret per i dati sensibili
...
### Combinare con i Gruppi di variabili

Le variabili survey funzionano bene insieme ai [Gruppi di variabili](../environment.md):
...
## Differenze rispetto ai Gruppi di variabili
