...
### Abilitazione dei prompt di Ansible
...
Vedere [Workspace di Terraform](../../../../docs/user-guide/apps/terraform/workspaces.md) per la configurazione dettagliata.
...
### Abilitazione dei prompt di Terraform
...
## Prompt di Bash, PowerShell e Python

Per i Task Template Bash, PowerShell e Python i prompt sono minimi, poiché la maggior parte della personalizzazione viene gestita tramite le [Variabili di survey](../../../../docs/user-guide/task-templates/survey-vars.md).
...
Vedere [Integration](../integrations.md) per la configurazione dei webhook.
...
### Combinare con le variabili di survey
...
### Documentare l'utilizzo tramite API
...
### Distribuzione graduale con Limit
...
- [Variabili di survey](../../../../docs/user-guide/task-templates/survey-vars.md) - Campi personalizzati per i Task Template
- [Task Template Ansible](../../../../docs/user-guide/apps/ansible.md) - Configurazione specifica di Ansible
- [Task Template Terraform](../../../../docs/user-guide/apps/terraform/README.md) - Configurazione specifica di Terraform
- [Schedule](../../../../docs/user-guide/schedules.md) - Esecuzione automatica dei Task
- [Integration](../integrations.md) - Task avviati da webhook
- [Documentazione API](../../reference/api.md) - Riferimento dell'API
