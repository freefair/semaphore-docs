...
![Statistiche del Project](../../../../static/assets/project-stats.webp)
...
Lo stesso grafico è disponibile per un singolo Task Template nella scheda **Details** della [pagina del Task Template](../../../../docs/user-guide/task-templates/README.md#template-page).

Per vedere le singole esecuzioni invece dei dati aggregati, utilizzare la scheda [History](history.md).
