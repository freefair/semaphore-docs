...
## Come funziona un percorso di sincronizzazione
...
## Effetti della sincronizzazione sulle chiavi
...
## Due ambiti: chiavi condivise e variabili d'ambiente
...
- **A livello di ambiente** — un [Gruppo di variabili](../../../../docs/user-guide/environment.md) può puntare a un archivio e ai suoi percorsi di sincronizzazione per importare i segreti come **variabili d'ambiente** limitate a quel gruppo.
