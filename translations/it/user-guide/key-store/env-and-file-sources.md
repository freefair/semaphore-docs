...
| **Storage**  | Un archivio di segreti esterno come [HashiCorp Vault](../../../../docs/user-guide/key-store/hashicorp-vault.md) | L'archivio e il percorso del segreto |
...
Consultare [Directory dei segreti](../../../../docs/admin-guide/configuration/config-file.md#secrets-directory) per le regole di precedenza.
