...
[pagina della guida utente sui JWT delle attività](../../../../docs/user-guide/task-templates/jwt.md).
...
> [`access_key_encryption`](../../../../docs/admin-guide/configuration/config-file.md). Assicurarsi
