...
[Chiavi di cifratura](../../../../docs/admin-guide/security/encryption.md).

<a id="re-encrypting-secrets-vault-rekey"></a>

## Ricifrare i segreti (`vault rekey`)
...
### Migrazione legacy a chiave singola
...
## Verificare l'uso delle chiavi (`vault check`)
