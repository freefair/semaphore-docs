...
Vedere [Operazioni Git](../../../docs/admin-guide/configuration/config-file.md#git-operations) per i dettagli su `git_client` e `git_attempts`.
...
Consultate [LDAP e AD](../../../docs/admin-guide/authentication/ldap.md) per il significato di ciascuna opzione.
