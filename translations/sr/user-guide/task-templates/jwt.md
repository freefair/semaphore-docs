...
Kada je [izdavanje JWT tokena uključeno na serveru](../../../../docs/admin-guide/security/jwt.md),
...
[skladištu ključeva](../../../../docs/user-guide/key-store.md) (Key Store) je to što svaki zadatak dobija **svež token
...
## Uključivanje JWT tokena na šablonu

U formi šablona pomerite se do odeljka **JWT** (pojavljuje se samo kada je
administrator [uključio izdavanje JWT tokena](../../../../docs/admin-guide/security/jwt.md)) i
...
## Korišćenje tokena unutar zadatka
...
### 1. Podesite JWT metod autentifikacije
...
### 3. Definišite OpenBao ulogu vezanu za šablon
