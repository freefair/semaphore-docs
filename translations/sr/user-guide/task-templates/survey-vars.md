...
## Dodavanje anketnih promenljivih u šablon
...
## Kako se anketne promenljive prosleđuju zadacima
...
## Korišćenje anketnih promenljivih
...
Više detalja potražite u dokumentaciji [Rasporedi](../../../../docs/user-guide/schedules.md).
...
Više detalja potražite u dokumentaciji [Integracije](../integrations.md).
...
### Koristite enum ili select za poznate opcije
...
### Cilj promenljive okruženja koristite promišljeno
...
### Obavezna polja označavajte s merom
...
### Koristite secret za osetljive podatke
...
### Kombinujte sa grupama promenljivih

Anketne promenljive dobro funkcionišu uz [grupe promenljivih](../environment.md) (Variable Groups):
...
### Isporuke specifične za okruženje
...
## Razlike u odnosu na grupe promenljivih
