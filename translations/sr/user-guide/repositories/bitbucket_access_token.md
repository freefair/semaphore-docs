...
3. Unesite `x-token-auth` kao **Login** i nalepite prethodno kopirani ključ u polje **Password**. Sačuvajte ključ.<br/><br/>![](../../../../static/assets/bitbucket_access_token_3.png)
4. Idite u odeljak **Repositories** i kliknite na dugme **New Repository**.
5. Unesite HTTPS URL repozitorijuma (`https://bitbucket.org/path/to/repo`), unesite ispravnu granu i izaberite prethodno kreirani **Access Key**.<br/><br/>![](../../../../static/assets/bitbucket_access_token_4.webp)
