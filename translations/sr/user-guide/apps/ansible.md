...
Semaphore ne podržava artefakte direktno, već samo obezbeđuje verzionisanje zadataka. Kreiranje artefakata morate sami implementirati. Pročitajte članak [CI/CD](../../admin-guide/cicd.md) da biste saznali kako se to radi.
...
#### Pokretanje zadatka kada se u repozitorijum doda novi commit
