...
![Dijalog Novi zadatak za Bash šablon](../../../../static/assets/task-new-bash.webp)
...
- Ako veoma kratka skripta ne proizvede nikakav izlaz u logu, pogledajte [Izlaz Bash skripte nedostaje ili je nepotpun](../../../../docs/faq/troubleshooting.md#bash-script-output-is-missing-or-incomplete) u vodiču za rešavanje problema.
- Za izvršavanje komandi na udaljenim hostovima umesto toga koristite [Ansible](ansible.md).
