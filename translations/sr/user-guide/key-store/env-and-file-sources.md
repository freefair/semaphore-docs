...
| **Storage**  | Eksterno skladište tajni kao što je [HashiCorp Vault](../../../../docs/user-guide/key-store/hashicorp-vault.md) | Skladište i putanju tajne |
...
Pogledajte [Direktorijum za tajne](../../../../docs/admin-guide/configuration/config-file.md#secrets-directory) za pravila prioriteta.
