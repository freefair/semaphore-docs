...
## Kako radi putanja sinhronizacije
...
## Šta sinhronizacija radi sa vašim ključevima
...
## Dva opsega: deljeni ključevi i promenljive okruženja
...
- **Nivo okruženja** — [grupa promenljivih](../../../../docs/user-guide/environment.md) (Variable Group) može da pokazuje na skladište i njegove putanje sinhronizacije da bi uvezla tajne kao **promenljive okruženja** ograničene na tu grupu.
