...
HashiCorp Vault se takođe može koristiti kao skladište za [grupe promenljivih](../../../../docs/user-guide/environment.md) (Variable Groups). Kada menjate grupu promenljivih, izaberite **HashiCorp Vault** kao tip skladišta i navedite putanju foldera u kome će tajne biti sačuvane.
