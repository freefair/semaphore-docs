...
### Primena izmena bez ponovnog pokretanja
...
> **Zaštitite datoteku sa ključevima**
>
...
### `encryption` (glavna konfiguracija)
...
### Nasleđeni jednostavni ključevi (glavna konfiguracija)
