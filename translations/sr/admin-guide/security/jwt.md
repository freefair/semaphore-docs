...
[stranicu vodiča za korisnike o JWT-ovima zadataka](../../../../docs/user-guide/task-templates/jwt.md).
...
> [`access_key_encryption`](../../../../docs/admin-guide/configuration/config-file.md). Obavezno
