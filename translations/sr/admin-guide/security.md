...
<a id="running-untrusted-code--playbooks"></a>

## Izvršavanje nepouzdanog koda / playbook-ova
...
- **Izolacija izvršavanja**<br />Podrazumevano je zadatak običan proces na Semaphore serveru, sa njegovim fajl sistemom i mrežnim pristupom. Izolacija je opciona: predajte zadatak [raneru](../../../docs/admin-guide/runners.md) podešenom sa `docker` ili `k8s` izvršiocem i svaki zadatak dobija nov kontejner ili Pod koji se briše po završetku.
...
<a id="updates--patch-management"></a>
...
<a id="reporting-vulnerabilities"></a>

## Prijavljivanje ranjivosti

Pronašli ste ranjivost? Pomozite nam da Semaphore ostane bezbedan:

- **Odgovorno obelodanjivanje**<br />Pošaljite nam e-poštu na the repository maintainers through a private GitHub vulnerability report.

<a id="vulnerability-resolution-targets"></a>

### Ciljni rokovi za otklanjanje ranjivosti
