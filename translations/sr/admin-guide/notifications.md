...
2. **Projekat dozvoljava upozorenja.** *Allow alerts for this project* u
   [podešavanjima projekta](../../../docs/user-guide/projects/settings.md) je glavni prekidač. Kada
...
3. **Šablon to traži.** Šablon zadatka bira da li šalje upozorenje pri uspehu, pri
   grešci ili nikako, pogledajte [Šablone zadataka](../../../docs/user-guide/task-templates/README.md).
...
| Kanal | Stranica |
|---|---|
| E-pošta (SMTP) | [E-pošta](../../../docs/admin-guide/notifications/email.md) |
...
## Prilagođavanja po projektu

Telegram podržava chat po projektu: podesite **Telegram Chat ID** u
[podešavanjima projekta](../../../docs/user-guide/projects/settings.md) da biste upozorenja jednog
