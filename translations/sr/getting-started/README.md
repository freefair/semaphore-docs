...
Za vođeno podešavanje koristite zvaničnu [stranicu za instalaciju Semaphore-a](../../../docs/admin-guide/configuration/config-file.md) da izaberete izdanje, napravite konfiguraciju i dobijete odgovarajuće komande za preuzimanje ili pokretanje.
...
| --- | --- | --- |
| **Nativni paket** | Podržan Linux server | [Instalacija pomoću upravljača paketima](../../../docs/admin-guide/installation/package-manager.md) |
| **Docker Compose** | Brza izolovana instalacija ili host za kontejnere | [Docker instalacija](../../../docs/admin-guide/installation/docker.md) |
| **Binarna arhiva** | macOS, Windows, FreeBSD ili Linux bez odgovarajućeg paketa | [Instalacija binarne datoteke](../../../docs/admin-guide/installation/binary-file.md) |
| **Kubernetes pomoću Helm-a** | Postojeći Kubernetes klaster | [Kubernetes instalacija](../../../docs/admin-guide/installation/k8s.md) |
...
>
> Pre korišćenja Semaphore-a u produkciji pregledajte [Konfiguraciju](../../../docs/admin-guide/configuration.md), [Bezbednost](../../../docs/admin-guide/security.md), [Runner-e](../../../docs/admin-guide/runners.md), [Visoku dostupnost](../../../docs/admin-guide/ha.md) i [Nadogradnju](../../../docs/admin-guide/upgrading.md).
...
![Ekran za prijavu u Semaphore](../../../static/assets/getting-started/sign-in.jpg)

Za početno podešavanje koristite administratorski nalog jer može da pravi projekte i korisnike. Obični korisnici se prijavljuju na istoj stranici nakon što administrator napravi njihove naloge i odobri pristup projektu. Pogledajte [Upravljanje korisnicima](../../../docs/user-guide/admin/users.md).
...
![Prazan obrazac New Project sa svim dostupnim poljima](../../../static/assets/getting-started/new-project-empty.jpg)

Novi projekat sadrži odeljke **Task Templates**, **Workflows**, **Schedule**, **Inventory**, **Variable Groups**, **Key Store** i **Repositories**. Pogledajte [Projekte](../../../docs/user-guide/projects.md) za podešavanja projekta, pristup tima, aktivnosti i istoriju.

<details>
<summary>Pogledajte ovaj korak</summary>

![Pravljenje prvog projekta u praznoj Semaphore instanci](../../../static/assets/getting-started/create-first-project.gif)
...
![Interfejs praznog Semaphore projekta pre dodavanja resursa i zadataka](../../../static/assets/getting-started/after-sign-in.jpg)
...
Dijagram pokazuje kako ovi resursi dovode do izvršavanja:
  ...
  ![Kako Semaphore resursi i okidači dovode do izvršavanja zadatka](../../../static/assets/getting-started/core-concepts.svg)
...
| Pojam | Uloga |
| --- | --- |
| [**Project**](../../../docs/user-guide/projects.md) | Izolovan radni prostor sa resursima automatizacije, dozvolama i istorijom izvršavanja. |
| [**Repository**](../../../docs/user-guide/repositories.md) | Upućuje na Git granu ili oznaku sa datotekama automatizacije koje zadatak koristi. |
| [**Key Store**](../../../docs/user-guide/key-store.md) | Čuva višekratne SSH ključeve, akreditive, tokene i Ansible Vault lozinke izvan Git-a i ulaznih podataka zadataka. |
| [**Inventory**](../../../docs/user-guide/inventory.md) | Govori Ansible-u kojim hostovima i grupama da upravlja i koje akreditive da koristi. |
| [**Variable Group**](../../../docs/user-guide/environment.md) | Čuva višekratne Ansible promenljive, promenljive okruženja i tajne za jedan ili više šablona. |
| [**Task Template**](../../../docs/user-guide/task-templates/README.md) | Čuva šta treba izvršiti: tip automatizacije, datoteku, repozitorijum, inventar, promenljive, tražene parametre i opcije izvršavanja. |
| [**Task (task run)**](../../../docs/user-guide/tasks.md) | Jedno izvršavanje sa sopstvenim ulazima, statusom, vremenskim oznakama, dnevnikom, detaljima i rezultatom. |
| **Workflow** | Povezuje šablone zadataka u putanju sa više koraka i granama za uspeh, neuspeh, odobrenje i beleške. |
| [**Schedule**](../../../docs/user-guide/schedules.md) | Pokreće šablon zadatka ili tok rada jednom ili ponavljano prema cron izrazu. |
| [**Runner**](../../../docs/admin-guide/runners.md) | Izvršava zadatke iz reda izvan glavnog Semaphore servera, na primer u drugoj mreži ili bezbednosnoj zoni. |

## 5. Povežite repozitorijum

Repository povezuje Semaphore sa automatizacijom u Git-u; Semaphore ne čuva sam playbook. Povežite svoj repozitorijum ili koristite vrednosti javnog demonstracionog primera ispod da biste ga tačno ponovili. [Integracije](../../../docs/user-guide/integrations.md) su zasebna funkcija za pokretanje automatizacije iz GitHub-a, GitLab-a ili drugih webhook izvora.
...
![Obrazac repozitorijuma popunjen javnim Semaphore demonstracionim repozitorijumom](../../../static/assets/getting-started/repository-settings.jpg)
...
![Povezan Demo repozitorijum na listi repozitorijuma projekta](../../../static/assets/getting-started/connected-repository.jpg)

Za privatni repozitorijum izaberite odgovarajuće Key Store akreditive umesto `None`. Pogledajte [Repozitorijume](../../../docs/user-guide/repositories.md) za lokalne putanje, HTTPS, SSH, grane, akreditive i datoteke zavisnosti.
...
![Obrazac New SSH Key za nalog koji se koristi na upravljanim hostovima](../../../static/assets/getting-started/add-managed-host-ssh-key.jpg)
...
Semaphore može da čuva tajne lokalno ili da se integriše sa spoljnim skladištima kao što su [HashiCorp Vault](../../../docs/user-guide/key-store/hashicorp-vault.md) i [Devolutions Server](../../../docs/user-guide/key-store/devolutions-server.md). Pogledajte [Skladište ključeva](../../../docs/user-guide/key-store.md) za sve podržane tipove akreditiva i opcije čuvanja.
...
![Ansible inventar iz datoteke podešen vrednostima demonstracionog repozitorijuma](../../../static/assets/getting-started/ansible-inventory-settings.jpg)
...
Pogledajte [Inventar](../../../docs/user-guide/inventory.md) za statičke, datotečne i dinamičke inventare.
...
![Grupa promenljivih podešena u tabelarnom uređivaču](../../../static/assets/getting-started/variable-group-table.jpg)

Pogledajte [Grupe promenljivih](../../../docs/user-guide/environment.md) za pravila prioriteta i opcije čuvanja tajni.
...
Primer preuzima tu ulogu iz Git podmodula i šalje jedan ICMP zahtev na the demo's configured public target, pa izvršni host mora imati pristup GitHub-u i odlazni ICMP. Ako je ICMP blokiran, koristite lokalni primer `get-started.yml`.

![ping.yml u povezanom GitHub repozitorijumu](../../../static/assets/getting-started/demo-playbook-github.jpg)
...
![Šablon Ansible zadatka sa repozitorijumom, inventarom i grupom promenljivih](../../../static/assets/getting-started/ansible-task-template-settings.jpg)

<details>
<summary>Pogledajte ovaj korak</summary>

![Uključivanje Ansible-a i pravljenje prvog šablona Ansible zadatka](../../../static/assets/getting-started/create-ansible-template.gif)
...
Pogledajte [Ansible šablone](../../../docs/user-guide/apps/ansible.md) i [Šablone zadataka](../../../docs/user-guide/task-templates/README.md) za sva polja i opcije izvršavanja.
...
![Dijalog New Task bez dodatnih opcija za Ansible playbook](../../../static/assets/getting-started/run-ansible-task-clean.jpg)
...
![Dnevnik uspešnog Ansible zadatka sa ping izlazom i PLAY RECAP rezimeom](../../../static/assets/getting-started/ansible-task-log-variable-group.jpg)
...
![Detalji zadatka sa šablonom, commit-om i vremenskim podacima](../../../static/assets/getting-started/ansible-task-details.jpg)

![Rezime zadatka sa brojem OK i Not OK hostova](../../../static/assets/getting-started/ansible-task-summary.jpg)
...
![Pokretanje Ansible zadatka i pregled njegovog dnevnika i detalja](../../../static/assets/getting-started/run-and-inspect-task.gif)

</details>

### Pronađite prethodna izvršavanja

Zatvorite prozor zadatka da biste se vratili na karticu **Tasks** šablona. Svako izvršavanje ima sopstveni broj zadatka, status, korisnika, vreme početka, trajanje i sačuvani dnevnik. **Dashboard → History** prikazuje izvršavanja svih šablona u projektu. Pogledajte [Zadatke](../../../docs/user-guide/tasks.md) i [Istoriju projekta](../../../docs/user-guide/projects/history.md) za više detalja.

![Istorija Ansible šablona sa uspešnim izvršavanjima zadataka](../../../static/assets/getting-started/ansible-template-history.jpg)
...
- Dodajte odgovarajuće privatne akreditive u [Skladište ključeva](../../../docs/user-guide/key-store.md) ako repozitorijum zahteva autentifikaciju.
- Napravite **Workflow** kada je za više šablona potreban uređen tok uspeha, neuspeha, odobrenja ili beleški.
- Koristite [Integracije](../../../docs/user-guide/integrations.md) za autentifikovane webhook okidače iz GitHub-a, GitLab-a ili drugog sistema.
- Koristite [API](../../../docs/reference/api.md) za programsko upravljanje resursima i pokretanje šablona.
- Dodajte [udaljeni runner](../../../docs/admin-guide/runners.md) kada izvršavanje mora biti u drugoj mreži, operativnom sistemu ili bezbednosnoj zoni.

Za produkciju postavite Semaphore iza HTTPS-a, zajedno pravite rezervne kopije baze podataka i tajne za šifrovanje pristupnih ključeva, podesite centralizovanu autentifikaciju i pregledajte [Bezbednost](../../../docs/admin-guide/security.md), [Dnevnike](../../../docs/admin-guide/logs.md) i [Nadogradnju](../../../docs/admin-guide/upgrading.md).
