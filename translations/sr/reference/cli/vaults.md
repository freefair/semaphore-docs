...
[Ključevi za šifrovanje](../../../../docs/admin-guide/security/encryption.md).

<a id="re-encrypting-secrets-vault-rekey"></a>

## Ponovno šifrovanje tajni (`vault rekey`)
...
### Rotacija ključeva bez prekida rada
...
### Migracija sa nasleđenog jednog ključa
...
## Provera upotrebe ključeva (`vault check`)
