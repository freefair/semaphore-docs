...
* [Swagger/OpenAPI](../../../docs/reference/api.md) &mdash; 如果您偏好交互式的、基于浏览器的体验，这是理想选择。
...
![API 令牌](../../../static/assets/api-tokens.webp)

点击 **新建令牌（New Token）**，输入名称，选择令牌的过期时间，然后复制创建后显示的值。参见[您的账户](../../../docs/user-guide/account.md#api-tokens)。

![新建令牌对话框](../../../static/assets/api-token-new.webp)
