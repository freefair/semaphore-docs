...
| **Storage**  | 外部密钥存储，例如 [HashiCorp Vault](../../../../docs/user-guide/key-store/hashicorp-vault.md) | 存储以及密钥路径 |
...
优先级规则请参阅[密钥目录](../../../../docs/admin-guide/configuration/config-file.md#secrets-directory)。
