...
![Bash 模板的新建任务对话框](../../../../static/assets/task-new-bash.webp)
...
- 如果非常短的脚本没有产生日志输出，请参阅故障排除指南中的 [Bash 脚本输出缺失或不完整](../../../../docs/faq/troubleshooting.md#bash-script-output-is-missing-or-incomplete)。
- 要在远程主机上运行命令，请改用 [Ansible](ansible.md)。
