...
构建模板生成制品：tarball、容器镜像或软件包。每个构建任务都会获得一个自动递增的版本号，从模板的 **Start Version** 开始（例如 `1.0.0`）。版本号显示在模板列表的 **Version** 列和任务历史中。
  ...
  ![构建模板的 New Task 对话框](../../../../static/assets/task-new-build.webp)
...
![部署模板的 New Task 对话框](../../../../static/assets/task-new-deploy.webp)
...
如需串联两个以上的步骤、添加审批或在失败时分支，请使用[工作流](../../../../docs/user-guide/workflows.md)。
