...
当[服务器上启用了 JWT 签发](../../../../docs/admin-guide/security/jwt.md)时，
...
相比存储在[密钥库](../../../../docs/user-guide/key-store.md)中的长期密钥，
...
在模板表单中滚动到 **JWT** 区域（只有在管理员[启用了 JWT 签发](../../../../docs/admin-guide/security/jwt.md)后才会显示），
然后勾选 **JWT enabled**。
