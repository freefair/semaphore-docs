...
更多详情请参阅[计划任务](../../../../docs/user-guide/schedules.md)文档。
...
调查变量可以与[变量组（Variable Groups）](../environment.md)很好地配合：
