...
提示（Prompts）是每种模板类型特有的预定义标志和选项，启用后可以在运行时进行自定义。与由你自行创建的自定义字段[调查变量](../../../../docs/user-guide/task-templates/survey-vars.md)不同，提示是内置选项，对应 Ansible、Terraform 及其他工具的特定 CLI 标志。
...
详细设置请参阅 [Terraform 工作区](../../../../docs/user-guide/apps/terraform/workspaces.md)。
...
## Bash、PowerShell 和 Python 提示

对于 Bash、PowerShell 和 Python 模板，提示非常少，因为大部分自定义都通过[调查变量](../../../../docs/user-guide/task-templates/survey-vars.md)完成。
...
webhook 配置请参阅[集成](../integrations.md)。
...
- [调查变量](../../../../docs/user-guide/task-templates/survey-vars.md) - 模板的自定义字段
- [Ansible 模板](../../../../docs/user-guide/apps/ansible.md) - Ansible 特定配置
- [Terraform 模板](../../../../docs/user-guide/apps/terraform/README.md) - Terraform 特定配置
- [计划任务](../../../../docs/user-guide/schedules.md) - 自动执行任务
- [集成](../integrations.md) - 由 webhook 触发的任务
- [API 文档](../../reference/api.md) - API 参考
