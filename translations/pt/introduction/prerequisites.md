...
esta página antes da [Instalação](../../../docs/admin-guide/installation.md) e a instalação em si
leva minutos.
...
a execução para [runners](../../../docs/admin-guide/runners.md) e dimensione-os em vez do host.
...
A [alta disponibilidade](../../../docs/admin-guide/ha.md) exige PostgreSQL ou MySQL mais Redis, e
...
| O seu provedor de identidade, se você usar um | Login por [LDAP](../../../docs/admin-guide/authentication/ldap.md) ou [OpenID Connect](../../../docs/admin-guide/authentication/openid.md). |
...
[TLS](../../../docs/admin-guide/reverse-proxy/README.md) na frente dela antes que alguém faça login: as sessões
...
- As imagens Docker já vêm com Ansible, Terraform, OpenTofu e as
  ...
  [Instalando dependências Python adicionais](../../../docs/admin-guide/installation/docker.md#installing-additional-python-dependencies).
...
Todas elas pertencem ao [Armazenamento de Chaves](../../../docs/user-guide/key-store.md), não ao repositório.
...
- [Instalação](../../../docs/admin-guide/installation.md) — escolha um método e instale.
- [Configuração](../../../docs/admin-guide/configuration.md) — como as opções são fornecidas e o que significam.
- [Primeiros passos](../../../docs/getting-started/README.md) — de um servidor instalado à primeira tarefa.
