...
[Chaves de criptografia](../../../../docs/admin-guide/security/encryption.md).

<a id="re-encrypting-secrets-vault-rekey"></a>

## Recriptografando segredos (`vault rekey`)
...
### Migração legada de chave única
...
## Verificando o uso das chaves (`vault check`)
