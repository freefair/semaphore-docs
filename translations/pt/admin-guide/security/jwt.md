...
[página do guia do usuário sobre JWTs de tarefas](../../../../docs/user-guide/task-templates/jwt.md).
...
> [`access_key_encryption`](../../../../docs/admin-guide/configuration/config-file.md). Certifique-se
