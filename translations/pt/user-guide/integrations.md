...
![Lista de integrações](../../../static/assets/integrations-list.webp)
...
![Detalhes da integração](../../../static/assets/integration-detail.webp)
...
## Observações sobre aliases e matchers
