...
## Executando em hosts Windows

Os modelos PowerShell exigem uma das seguintes opções:
- Um **runner Windows** — um runner do Semaphore implantado em um host Windows. Consulte [Runners](../../../../docs/admin-guide/runners.md).
