...
O Semaphore não oferece suporte a artefatos de forma nativa; ele fornece apenas o versionamento de tarefas. Você deve implementar a criação do artefato por conta própria. Leia o artigo [CI/CD](../../admin-guide/cicd.md) para saber como fazer isso.
...
#### Executar uma tarefa quando um novo commit é adicionado ao repositório
