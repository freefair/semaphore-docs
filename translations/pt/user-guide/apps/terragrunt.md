...
O [Terragrunt](https://terragrunt.gruntwork.io/) é um wrapper para Terraform e OpenTofu que mantém as configurações DRY e gerencia dependências entre módulos. O Semaphore o executa da mesma forma que o [Terraform/OpenTofu](../../../../docs/user-guide/apps/terraform/README.md), com algumas diferenças descritas aqui.

<a id="prerequisites"></a>

## Pré-requisitos

1. Instale o binário `terragrunt` e um binário `terraform` ou `tofu` no servidor Semaphore ou no [runner](../../../../docs/admin-guide/runners.md) que executa as tarefas.
2. Habilite o aplicativo **Terragrunt Code**: ele vem desabilitado por padrão. Abra **Aplicativos** no menu da conta e ative a chave, consulte [Aplicativos](../../../../docs/user-guide/apps/README.md).

<a id="creating-a-terragrunt-template"></a>

## Criando um modelo Terragrunt
...
4. Selecione ou crie um **Workspace** no campo Inventário. Os modelos Terragrunt usam inventários do tipo `terragrunt-workspace`, consulte [Workspaces](terraform/workspaces.md).
5. Clique em **Criar** e depois em **Executar**.

![Modelo Terragrunt](../../../../static/assets/templates-list.webp)
...
- O backend de estado HTTP e a lista de estados na aba **Workspaces** funcionam como no Terraform, consulte [Backend HTTP](../../../../docs/user-guide/apps/terraform/states.md).
