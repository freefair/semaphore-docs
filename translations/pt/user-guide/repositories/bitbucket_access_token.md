...
3. Digite `x-token-auth` em **Login** e cole a chave copiada anteriormente no campo **Senha**. Salve a chave.<br/><br/>![](../../../../static/assets/bitbucket_access_token_3.png)
4. Vá até a seção **Repositórios** e clique no botão **Novo Repositório**.
5. Digite a URL HTTPS do repositório (`https://bitbucket.org/path/to/repo`), informe o branch correto e selecione a **Chave de Acesso** criada anteriormente.<br/><br/>![](../../../../static/assets/bitbucket_access_token_4.webp)
