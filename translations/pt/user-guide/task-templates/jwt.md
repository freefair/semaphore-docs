...
Quando a [emissão de JWT está habilitada no servidor](../../../../docs/admin-guide/security/jwt.md),
...
[Key Store](../../../../docs/user-guide/key-store.md) é que cada tarefa recebe um **token novo
...
## Habilitando JWTs em um template

No formulário do template, role até a seção **JWT** (ela só aparece quando o
administrador [habilitou a emissão de JWT](../../../../docs/admin-guide/security/jwt.md)) e
marque **JWT enabled**.
...
## Usando o token dentro de uma tarefa
...
### 3. Defina uma role do OpenBao vinculada a um template
