...
## Como funciona um caminho de sincronização
...
## O que a sincronização faz com as suas chaves
...
## Dois escopos: chaves compartilhadas e variáveis de ambiente
...
- **Nível do ambiente** — um [Grupo de Variáveis](../../../../docs/user-guide/environment.md) pode apontar para um armazenamento e seus caminhos de sincronização para importar segredos como **variáveis de ambiente** com escopo nesse grupo.
