...
O HashiCorp Vault também pode ser usado como armazenamento para [Grupos de Variáveis](../../../../docs/user-guide/environment.md). Ao editar um grupo de variáveis, selecione **HashiCorp Vault** como o tipo de armazenamento e especifique o caminho da pasta onde os segredos serão armazenados.
