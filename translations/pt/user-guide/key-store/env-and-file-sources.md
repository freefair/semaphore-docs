...
| **Storage**  | Armazenamento de segredos externo, como o [HashiCorp Vault](../../../../docs/user-guide/key-store/hashicorp-vault.md) | O armazenamento e o caminho do segredo |
...
Consulte [Diretório de segredos](../../../../docs/admin-guide/configuration/config-file.md#secrets-directory) para as regras de precedência.
