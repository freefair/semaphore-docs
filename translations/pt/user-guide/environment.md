...
![Lista de grupos de variáveis](../../../static/assets/variable-groups-list.webp)
...
## Atualizando um grupo de variáveis
...
## Excluindo o grupo de variáveis
...
## Usando Grupos de Variáveis - Terraform/OpenTofu
