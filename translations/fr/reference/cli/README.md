...
[référence des commandes](../../../../docs/reference/cli/commands.md). La plupart des tâches
d'administration disposent d'un groupe de commandes dédié :

| Groupe de commandes | Rôle |
|---------------------|------|
| [`semaphore users`](../../../../docs/reference/cli/users.md) | Ajouter, modifier, supprimer et consulter des utilisateurs ; gérer les tokens d'API et le TOTP (2FA). |
| [`semaphore projects`](../../../../docs/reference/cli/projects.md) | Exporter et importer des projets (sauvegardes). |
| [`semaphore vaults`](../../../../docs/reference/cli/vaults.md) | Rechiffrer les secrets stockés et consulter l'utilisation des clés de chiffrement. |
| [`semaphore runner`](../../../../docs/reference/cli/runners.md) | Fonctionner en mode runner et enregistrer/désenregistrer des runners. |
| [`semaphore migrate`](../../../../docs/reference/cli/migrations.md) | Appliquer ou annuler des migrations de base de données. |
...
### Comment le fichier de configuration est trouvé
...
par défaut sont utilisées. Consultez [Configuration](../../../../docs/admin-guide/configuration.md) pour la liste
...
Exécute Semaphore en tant que runner de tâches. Consultez [Runners](../../../../docs/reference/cli/runners.md) pour
...
[Migrations de base de données](../../../../docs/reference/cli/migrations.md) pour appliquer ou annuler des
