...
[Clés de chiffrement](../../../../docs/admin-guide/security/encryption.md).

<a id="re-encrypting-secrets-vault-rekey"></a>

## Rechiffrer les secrets (`vault rekey`)
...
### Migration héritée à clé unique
...
## Vérifier l'utilisation des clés (`vault check`)
