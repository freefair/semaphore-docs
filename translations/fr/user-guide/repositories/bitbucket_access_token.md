...
3. Saisissez `x-token-auth` comme **Login** et collez la clé copiée précédemment dans le champ **Mot de passe**. Enregistrez la clé.<br/><br/>![](../../../../static/assets/bitbucket_access_token_3.png)
4. Allez dans la section **Dépôts** et cliquez sur le bouton **Nouveau dépôt**.
5. Saisissez l'URL HTTPS du dépôt (`https://bitbucket.org/path/to/repo`), indiquez la bonne branche et sélectionnez la **clé d'accès** créée précédemment.<br/><br/>![](../../../../static/assets/bitbucket_access_token_4.webp)
