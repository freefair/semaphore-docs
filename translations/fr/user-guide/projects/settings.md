...
![Paramètres du projet](../../../../static/assets/project-settings-general.webp)
...
| **Identifiant de conversation Telegram** | Facultatif. Envoie les alertes de ce projet vers une conversation Telegram différente de celle configurée globalement. Voir [Notifications Telegram](../../../../docs/admin-guide/notifications/telegram.md#per-project-chat-ids). |
...
**Tester les alertes** envoie un message de test via chaque [canal de notification](../../../../docs/admin-guide/notifications.md) configuré, afin que vous puissiez vérifier la configuration du serveur sans exécuter de tâche. **Enregistrer** applique les modifications.
...
- Membres et rôles : [Équipes](../../../../docs/user-guide/team.md)
- Runners rattachés au projet et étiquettes de runner : [Runners de projet](../../../../docs/user-guide/projects/runners.md)
- Les canaux de notification sont configurés sur le serveur : [Notifications](../../../../docs/admin-guide/notifications.md)
