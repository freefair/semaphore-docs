...
Les invites sont des indicateurs et des options prédéfinis, propres à chaque type de modèle, que vous pouvez activer pour permettre une personnalisation au moment de l'exécution. Contrairement aux [Variables de questionnaire](../../../../docs/user-guide/task-templates/survey-vars.md), qui sont des champs personnalisés que vous créez, les invites sont des options intégrées qui correspondent à des indicateurs CLI spécifiques d'Ansible, Terraform et d'autres outils.
...
## Invites et variables de questionnaire
...
Voir [Espaces de travail Terraform](../../../../docs/user-guide/apps/terraform/workspaces.md) pour une mise en place détaillée.
...
Pour les modèles Bash, PowerShell et Python, les invites sont minimales car l'essentiel de la personnalisation passe par les [Variables de questionnaire](../../../../docs/user-guide/task-templates/survey-vars.md).
...
Voir [Intégrations](../integrations.md) pour la configuration des webhooks.
...
### N'activez que les invites nécessaires
...
### Combinez avec les variables de questionnaire
...
### Documentez l'utilisation de l'API
...
### Utilisez Limit pour des tests sûrs
...
### Validez les combinaisons d'invites
...
### Gestion des environnements avec les espaces de travail
...
- [Variables de questionnaire](../../../../docs/user-guide/task-templates/survey-vars.md) - Champs personnalisés pour les modèles
- [Modèles Ansible](../../../../docs/user-guide/apps/ansible.md) - Configuration propre à Ansible
- [Modèles Terraform](../../../../docs/user-guide/apps/terraform/README.md) - Configuration propre à Terraform
- [Planifications](../../../../docs/user-guide/schedules.md) - Exécution automatisée des tâches
- [Intégrations](../integrations.md) - Tâches déclenchées par webhook
- [Documentation de l'API](../../reference/api.md) - Référence de l'API
