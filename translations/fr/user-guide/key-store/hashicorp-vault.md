...
HashiCorp Vault peut également servir de stockage pour les [groupes de variables](../../../../docs/user-guide/environment.md). Lors de la modification d'un groupe de variables, sélectionnez **HashiCorp Vault** comme type de stockage et indiquez le chemin du dossier dans lequel les secrets seront stockés.
