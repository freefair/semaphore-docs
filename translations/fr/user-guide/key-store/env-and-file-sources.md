...
| **Storage**  | Un stockage de secrets externe tel que [HashiCorp Vault](../../../../docs/user-guide/key-store/hashicorp-vault.md) | Le stockage et le chemin du secret |
...
Consultez [Répertoire des secrets](../../../../docs/admin-guide/configuration/config-file.md#secrets-directory) pour les règles de priorité.
