...
## Fonctionnement d'un chemin de synchronisation
...
## Effets de la synchronisation sur vos clés
...
## Deux portées : clés partagées et variables d'environnement
...
- **Au niveau de l'environnement** — un [groupe de variables](../../../../docs/user-guide/environment.md) peut pointer vers un stockage et ses chemins de synchronisation pour importer des secrets en tant que **variables d'environnement** limitées à ce groupe.
