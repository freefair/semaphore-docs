...
Semaphore ne prend pas en charge les artefacts nativement ; il fournit uniquement le versionnement des tâches. C'est à vous d'implémenter la création des artefacts. Lisez l'article [CI/CD](../../admin-guide/cicd.md) pour savoir comment procéder.
...
#### Exécuter une tâche lorsqu'un nouveau commit est ajouté au dépôt
...
#### Arguments Galaxy supplémentaires
...
### Plusieurs mots de passe de coffre
