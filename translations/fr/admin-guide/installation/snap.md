...
&#x20;Vous trouverez la liste des options disponibles dans la [référence des options de configuration](../../../../docs/admin-guide/configuration.md#configuration-options).
