...
[page du guide utilisateur sur les JWT de tâches](../../../../docs/user-guide/task-templates/jwt.md).
...
> [`access_key_encryption`](../../../../docs/admin-guide/configuration/config-file.md). Assurez-vous
