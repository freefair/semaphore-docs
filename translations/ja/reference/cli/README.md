...
[コマンドリファレンス](../../../../docs/reference/cli/commands.md)を参照してください。ほとんどの管理タスクには専用のコマンドグループがあります:

| コマンドグループ | 用途 |
|---------------|---------|
| [`semaphore users`](../../../../docs/reference/cli/users.md) | ユーザーの追加、変更、削除、参照。API トークンと TOTP (2FA) の管理。 |
| [`semaphore projects`](../../../../docs/reference/cli/projects.md) | プロジェクトのエクスポートとインポート (バックアップ)。 |
| [`semaphore vaults`](../../../../docs/reference/cli/vaults.md) | 保存されたシークレットの再暗号化と、暗号化キーの使用状況の確認。 |
| [`semaphore runner`](../../../../docs/reference/cli/runners.md) | ランナーモードでの実行と、ランナーの登録/登録解除。 |
| [`semaphore migrate`](../../../../docs/reference/cli/migrations.md) | データベースマイグレーションの適用またはロールバック。 |
...
`start`、`unregister`) は[ランナー](../../../../docs/reference/cli/runners.md)を参照してください。
...
ついては[データベースマイグレーション](../../../../docs/reference/cli/migrations.md)を参照してください。
