...
| **Storage**  | [HashiCorp Vault](../../../../docs/user-guide/key-store/hashicorp-vault.md) などの外部シークレットストレージ | ストレージとシークレットのパス |
...
優先順位のルールについては、[シークレットディレクトリ](../../../../docs/admin-guide/configuration/config-file.md#secrets-directory)を参照してください。
