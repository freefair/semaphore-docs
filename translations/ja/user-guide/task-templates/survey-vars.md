...
詳細については[スケジュール](../../../../docs/user-guide/schedules.md)のドキュメントを参照してください。
...
詳細については[インテグレーション](../integrations.md)のドキュメントを参照してください。
...
サーベイ変数は[変数グループ](../environment.md)と相性よく機能します。
