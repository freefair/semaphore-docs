...
プロンプトは、テンプレートの種類ごとに用意されている定義済みのフラグやオプションで、有効にすると実行時にカスタマイズできるようになります。自分で作成するカスタム項目である[サーベイ変数](../../../../docs/user-guide/task-templates/survey-vars.md)とは異なり、プロンプトは Ansible、Terraform、その他のツールの特定の CLI フラグに対応する組み込みのオプションです。
...
詳細なセットアップについては、[Terraform のワークスペース](../../../../docs/user-guide/apps/terraform/workspaces.md)を参照してください。
...
## Bash、PowerShell、Python のプロンプト

Bash、PowerShell、Python のテンプレートでは、カスタマイズのほとんどが[サーベイ変数](../../../../docs/user-guide/task-templates/survey-vars.md)で処理されるため、プロンプトは最小限です。
...
Webhook の設定については、[インテグレーション](../integrations.md)を参照してください。
...
- [サーベイ変数](../../../../docs/user-guide/task-templates/survey-vars.md) - テンプレートのカスタム項目
- [Ansible のテンプレート](../../../../docs/user-guide/apps/ansible.md) - Ansible 固有の設定
- [Terraform のテンプレート](../../../../docs/user-guide/apps/terraform/README.md) - Terraform 固有の設定
- [スケジュール](../../../../docs/user-guide/schedules.md) - タスクの自動実行
- [インテグレーション](../integrations.md) - Webhook で開始するタスク
- [API ドキュメント](../../reference/api.md) - API リファレンス
