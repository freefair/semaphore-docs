...
[サーバーで JWT の発行が有効になっている](../../../../docs/admin-guide/security/jwt.md)場合、
...
[キーストア](../../../../docs/user-guide/key-store.md)に保存された長期的なシークレットと比べた利点は、
...
[JWT の発行を有効にした](../../../../docs/admin-guide/security/jwt.md)場合にのみ表示されます）、
