...
設定とタスク内での利用方法については、
[タスク JWT に関するユーザーガイドのページ](../../../../docs/user-guide/task-templates/jwt.md)を参照してください。
...
>
> 署名キーは
> [`access_key_encryption`](../../../../docs/admin-guide/configuration/config-file.md) キーで保存時に暗号化されます。JWT を有効にする**前に**、
