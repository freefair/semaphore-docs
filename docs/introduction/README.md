...
install it or only use it. It answers the questions that come before any procedure:
what the product does, what a deployment is made of, what the words in the interface
