<!-- Generated by tools/clidocs. Do not edit by hand. -->
...
See [CLI](README.md) for the lookup order.
...
| `--debug-filter` | string | — | Debug component filter, e.g. 'runner,task_*' or '*,-db' |
...
| Subcommand | Purpose |
|---|---|
| [`semaphore users totp disable`](#semaphore-users-totp-disable) | Locally reset TOTP verification and revoke all sessions |

## `semaphore users totp disable`

Locally reset TOTP verification and revoke all sessions
