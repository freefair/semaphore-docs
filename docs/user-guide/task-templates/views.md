...
|---|---|
| **Title** | The tab label. |
| **Type** | **Custom** shows only templates assigned to this view. **All** shows every template of the project. |
| **Sort by** and **Reverse** | Default sort order of the templates in the tab. |
| **Hidden** | Keep the view but hide the tab. |
