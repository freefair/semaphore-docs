...
- If a very short script produces no log output, see [Bash script output is missing or incomplete](/admin-guide/troubleshooting#bash-script-output-is-missing-or-incomplete) in the troubleshooting guide.
