...
See [Git operations](../admin-guide/configuration/config-file.md#git-operations) for details on `git_client` and `git_attempts`.
...
See [LDAP and AD](../admin-guide/authentication/ldap.md) for the meaning of each option.
